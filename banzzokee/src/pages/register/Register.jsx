  ...
  const doSignUp = async (e) => {
    ...
    try {
      ...
      if (!passwordRegex.test(inputValue.password)) {
        setErrors({
          ...errors,
          password: '비밀번호는 숫자, 영어 대소문자, 특수기호를 모두 사용하고 8자 이상이어야 합니다.',
        });
        return;
      } else {
      ...
      const inputdata = {
        ...
        confirmPassword: `${inputValue.passwordconfirm}`,
            ...
            <div className={styles.emailconfirmBox}>
              <div className={styles.inputGroup}>
                ...
                <button
                  ...
                  onClick={doEmailVerification}
                  className={styles.emailconfirmButton}
                >
                  인증하기
                </button>
              </div>
